...
class UpdatePatientUseCaseTest {
    ...
    private UpdatePatientRequest request;
    ...
    void setUp() {
        ...
        request = UpdatePatientRequest.builder()
    ...
    void shouldUpdatePatientSuccessfully() {
        ...
        PatientResponse result =
                useCase.execute(patientId, request);
        ...
        verify(mapper).updateEntity(patient, request);
